"""View package for PostePay Evolution.

This module contains the implementation moved from the legacy
`app.views.ppay_evolution` top-level module. The top-level module
remains as a compatibility shim that re-exports from this package.
"""
